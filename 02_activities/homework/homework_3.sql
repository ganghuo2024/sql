...
SELECT vendor_id, COUNT(*) AS booth_rent_times_per_vendor
...
AS [customer spending in April 2022]
FROM customer_purchases_cte cpc
JOIN customer_purchases cp
ON cpc.customer_id = cp.customer_id
WHERE cpc.year = '2022' AND cpc.month = '04'
GROUP BY cpc.customer_id;